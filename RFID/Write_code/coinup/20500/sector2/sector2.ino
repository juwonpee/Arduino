...
///Block 08, type A, key 6677636f696e :00  00  00  00  00  00  00  00  00  00  00  00  00  00  00  00
  byte dataBlock8[]    = {
    0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 
...
//Block 09, type A, key 6677636f696e :88  91  80  00  00  00  ff  07  80  69  ff  ff  ff  ff  ff  ff 
  byte dataBlock9[]    = {
    0x88, 0x91, 0x80, 0x00, 
    0x00, 0x00, 0xFF, 0x07, 
    0x80, 0x69, 0xFF, 0xFF, 
...
//Block 10, type A, key 6677636f696e :88  02  00  05  00  00  ff  07  80  69  ff  ff  ff  ff  ff  ff    
  byte dataBlock10[]    = {
    0x88, 0x02, 0x00, 0x05, 
    0x00, 0x00, 0xFF, 0x07, 
    0x80, 0x69, 0xFF, 0xFF, 
...
//Block 11, type A, key 6677636f696e :00  00  00  00  00  00  ff  07  80  69  ff  ff  ff  ff  ff  ff  sector 2
  byte dataBlock11[]    = {
